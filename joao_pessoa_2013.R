...
### Subseccionar Dados de Joao Pessoa de 2013

munic_2013 <- subset(brasil_munic_2013, id %in% c(2507507))

###1 Seleção de Dados pa RENDA
renda_2013 <- data.frame(count(munic_2013, "FX_RENDA"))

renda_2013<- renda_2013%>% replace_na(list(FX_RENDA = "Sem Dados"))

renda_2013$FX_RENDA[which(renda_2013$FX_RENDA=="1")] <- "Até R$ 89,00"
renda_2013$FX_RENDA[which(renda_2013$FX_RENDA=="2")] <- "Entre R$ 89,01 e R$ 178,00"
renda_2013$FX_RENDA[which(renda_2013$FX_RENDA=="3")] <- "Até 1/2 Salário Mínimo"
renda_2013$FX_RENDA[which(renda_2013$FX_RENDA=="4")] <- "Acima de 1/2 Salário Mínimo"

write.xlsx(renda_2013, "/Users/wemigliari/Documents/R/tabelas/min_cid_observatorio/joao_pessoa/2013.xlsx",
...
write.xlsx(pbf_2013, "/Users/wemigliari/Documents/R/tabelas/min_cid_observatorio/joao_pessoa/2013.xlsx",
...
fam_ind_2013  <- fam_ind_2013 %>% replace_na(list(IN_FAMILIA_INDIGENA_FAM = "Sem Dados"))

fam_ind_2013$IN_FAMILIA_INDIGENA_FAM[which(fam_ind_2013$IN_FAMILIA_INDIGENA_FAM=="1")] <- "Sim"
fam_ind_2013$IN_FAMILIA_INDIGENA_FAM[which(fam_ind_2013$IN_FAMILIA_INDIGENA_FAM=="2")] <- "Não"

write.xlsx(fam_ind_2013, "/Users/wemigliari/Documents/R/tabelas/min_cid_observatorio/joao_pessoa/2013.xlsx",
...
quilom_2013  <- quilom_2013 %>% replace_na(list(IN_FAMILIA_QUILOMBOLA_FAM = "Sem Dados"))

quilom_2013$IN_FAMILIA_QUILOMBOLA_FAM[which(quilom_2013$IN_FAMILIA_QUILOMBOLA_FAM=="1")] <- "Sim"
quilom_2013$IN_FAMILIA_QUILOMBOLA_FAM[which(quilom_2013$IN_FAMILIA_QUILOMBOLA_FAM=="2")] <- "Não"


write.xlsx(quilom_2013, "/Users/wemigliari/Documents/R/tabelas/min_cid_observatorio/joao_pessoa/2013.xlsx",
...
write.xlsx(mds_fam_2013, "/Users/wemigliari/Documents/R/tabelas/min_cid_observatorio/joao_pessoa/2013.xlsx",
...
write.xlsx(ult_atua_2013, "/Users/wemigliari/Documents/R/tabelas/min_cid_observatorio/joao_pessoa/2013.xlsx",
...
write.xlsx(esta_cadas_2013, "/Users/wemigliari/Documents/R/tabelas/min_cid_observatorio/joao_pessoa/2013.xlsx",
...
write.xlsx(sexo_2013, "/Users/wemigliari/Documents/R/tabelas/min_cid_observatorio/joao_pessoa/2013.xlsx",
...
write.xlsx(cor_2013, "/Users/wemigliari/Documents/R/tabelas/min_cid_observatorio/joao_pessoa/2013.xlsx",
...
write.xlsx(idade_2013, "/Users/wemigliari/Documents/R/tabelas/min_cid_observatorio/joao_pessoa/2013.xlsx",
...
write.xlsx(transtorno_2013, "/Users/wemigliari/Documents/R/tabelas/min_cid_observatorio/joao_pessoa/2013.xlsx",
...
write.xlsx(ler_escrever_2013, "/Users/wemigliari/Documents/R/tabelas/min_cid_observatorio/joao_pessoa/2013.xlsx",
...
instrucao_2013 <- instrucao_2013%>% replace_na(list(GRAU_INSTRUCAO = "Sem Dados"))

instrucao_2013$GRAU_INSTRUCAO[which(instrucao_2013$GRAU_INSTRUCAO=="0")] <- "Sem Dados"
instrucao_2013$GRAU_INSTRUCAO[which(instrucao_2013$GRAU_INSTRUCAO=="1")] <- "Sem Instrução"
instrucao_2013$GRAU_INSTRUCAO[which(instrucao_2013$GRAU_INSTRUCAO=="2")] <- "Fundamental Incompleto"
instrucao_2013$GRAU_INSTRUCAO[which(instrucao_2013$GRAU_INSTRUCAO=="3")] <- "Fundamental Completo"
instrucao_2013$GRAU_INSTRUCAO[which(instrucao_2013$GRAU_INSTRUCAO=="4")] <- "Ensino Médio Incompleto"
instrucao_2013$GRAU_INSTRUCAO[which(instrucao_2013$GRAU_INSTRUCAO=="5")] <- "Ensino Médio Completo"
instrucao_2013$GRAU_INSTRUCAO[which(instrucao_2013$GRAU_INSTRUCAO=="6")] <- "Superior"


write.xlsx(instrucao_2013, "/Users/wemigliari/Documents/R/tabelas/min_cid_observatorio/joao_pessoa/2013.xlsx",
...
write.xlsx(curso_2013, "/Users/wemigliari/Documents/R/tabelas/min_cid_observatorio/joao_pessoa/2013.xlsx",
...
write.xlsx(principal_trabalho_2013, "/Users/wemigliari/Documents/R/tabelas/min_cid_observatorio/joao_pessoa/2013.xlsx",
...
write.xlsx(trabalho_12_meses_2013, "/Users/wemigliari/Documents/R/tabelas/min_cid_observatorio/joao_pessoa/2013.xlsx",
